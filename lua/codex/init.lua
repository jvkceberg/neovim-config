...
local function open_split()
  ...
  local direction = split.direction == "horizontal" and "" or "vertical "
  vim.cmd(("%s %s%dnew"):format(split.position, direction, split.size))
...
local function start_session(extra_args, prompt)
  ...
  vim.wo[win].winfixheight = split.direction == "horizontal"
  vim.wo[win].winfixwidth = split.direction ~= "horizontal"
